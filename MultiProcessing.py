#multiproccessing = running tasks in parallel on different cpu cores, bypasses GIL used for threading
#                   multiproccessing = better for cpu bound tasks (heavy cpu usage)
